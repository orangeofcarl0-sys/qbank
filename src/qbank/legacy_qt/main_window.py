...
from qbank.legacy_qt.question_dialog import QuestionIdentityDialog
from qbank.legacy_qt.tag_dialogs import TagManagerDialog, TagOverviewDialog
from qbank.legacy_qt.widgets import DetailDrawer, NavigationPane, WebWorkspace, WorkspaceMode
...
class DesktopMainWindow(QMainWindow):
    ...
    def _build_window(self) -> None:
        self.setWindowTitle("QBank Studio Legacy")
    ...
    def _update_title(self) -> None:
        ...
        self.setWindowTitle(f"QBank Studio Legacy · {project}{suffix}{marker}")
